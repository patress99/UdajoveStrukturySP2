...
namespace structures
{
		...
		if (this != &other)
		{
			if (this->size_ == other.size_) {
				*vector_ = *other.vector_;
				...
				throw std::invalid_argument("Polia sa nezhoduju!");
			}
		}
		return *this;
	}
	...
	{
		int indexVoVektore = mapFunction(index);
		byte* bytePtrVoVektore = vector_->getBytePointer(indexVoVektore);
		T* TptrVoVektore = reinterpret_cast<T*>(bytePtrVoVektore);
		return *TptrVoVektore;
	}
